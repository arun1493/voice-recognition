...
import type {
  DataValidatorServiceClient as _learningmotors_pb_data_validator_DataValidatorServiceClient,
  DataValidatorServiceDefinition as _learningmotors_pb_data_validator_DataValidatorServiceDefinition
} from "./learningmotors/pb/data_validator/DataValidatorService";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      closeencounters: {
        RawEncounter: MessageTypeDefinition;
      };
      common: {
      ...
      composer: {
        ...
        UpdateNotification: MessageTypeDefinition;
      };
      data_validator: {
        CreateDataRequest: MessageTypeDefinition;
        CreateDataResponse: MessageTypeDefinition;
        Data: MessageTypeDefinition;
        DataValidatorService: SubtypeConstructor<
          typeof grpc.Client,
          _learningmotors_pb_data_validator_DataValidatorServiceClient
        > & { service: _learningmotors_pb_data_validator_DataValidatorServiceDefinition };
        GetDataRequest: MessageTypeDefinition;
        GetDataResponse: MessageTypeDefinition;
        GetValidatedDataFileRequest: MessageTypeDefinition;
        GetValidatedDataFileResponse: MessageTypeDefinition;
        SlotValue: MessageTypeDefinition;
        UpdateDataRequest: MessageTypeDefinition;
        UpdateDataResponse: MessageTypeDefinition;
        ValidatedExamples: MessageTypeDefinition;
        ValidationState: EnumTypeDefinition;
      };
      emr: {
        EMRIdentifiers: MessageTypeDefinition;
        Record: MessageTypeDefinition;
        RecordDataDetail: MessageTypeDefinition;
      };
      emr_notetypes: {
      ...
      service: {
        ServiceName: EnumTypeDefinition;
        UpdateNotification: MessageTypeDefinition;
      };
      user: {
