...
import type {
  TranscriptServiceClient as _learningmotors_pb_transcript_TranscriptServiceClient,
  TranscriptServiceDefinition as _learningmotors_pb_transcript_TranscriptServiceDefinition
} from "./learningmotors/pb/transcript/TranscriptService";
import type {
  ...
  learningmotors: {
    pb: {
      ...
      transcript: {
        ...
        ExportNoteAudioRequest: MessageTypeDefinition;
        GetSessionDetailsRequest: MessageTypeDefinition;
        GetSessionDetailsResponse: MessageTypeDefinition;
        TranscriptResponse: MessageTypeDefinition;
        TranscriptService: SubtypeConstructor<
          typeof grpc.Client,
          _learningmotors_pb_transcript_TranscriptServiceClient
        > & { service: _learningmotors_pb_transcript_TranscriptServiceDefinition };
      };
      user: {
