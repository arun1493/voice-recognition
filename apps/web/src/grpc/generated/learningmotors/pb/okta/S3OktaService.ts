...
export interface S3OktaServiceClient extends grpc.Client {
  ActivateAccount(
...
export interface S3OktaServiceHandlers extends grpc.UntypedServiceImplementation {
...
export interface S3OktaServiceDefinition extends grpc.ServiceDefinition {
