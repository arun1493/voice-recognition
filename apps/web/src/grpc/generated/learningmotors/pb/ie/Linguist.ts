// Original file: node_modules/protobufs/src/learningmotors/pb/ie/linguist.proto
...
export interface LinguistClient extends grpc.Client {
  Extract(
...
export interface LinguistHandlers extends grpc.UntypedServiceImplementation {
  Extract: grpc.handleUnaryCall<_learningmotors_pb_ie_Request__Output, _learningmotors_pb_ie_Response>;
}

export interface LinguistDefinition extends grpc.ServiceDefinition {
