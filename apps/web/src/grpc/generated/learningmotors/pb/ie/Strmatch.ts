// Original file: node_modules/protobufs/src/learningmotors/pb/ie/strmatch.proto
...
export interface StrmatchClient extends grpc.Client {
  Extract(
...
export interface StrmatchHandlers extends grpc.UntypedServiceImplementation {
  Extract: grpc.handleUnaryCall<_learningmotors_pb_ie_Request__Output, _learningmotors_pb_ie_Response>;
}

export interface StrmatchDefinition extends grpc.ServiceDefinition {
