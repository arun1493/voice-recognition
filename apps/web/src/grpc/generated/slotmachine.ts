...
import type {
  SlotMachineClient as _learningmotors_pb_ie_SlotMachineClient,
  SlotMachineDefinition as _learningmotors_pb_ie_SlotMachineDefinition
} from "./learningmotors/pb/ie/SlotMachine";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      ie: {
        ResolveRequest: MessageTypeDefinition;
        ResolveResponse: MessageTypeDefinition;
        SlotMachine: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_ie_SlotMachineClient> & {
          service: _learningmotors_pb_ie_SlotMachineDefinition;
        };
      };
      macros: {
