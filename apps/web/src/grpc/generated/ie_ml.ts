...
import type {
  IEMLClient as _learningmotors_pb_ie_IEMLClient,
  IEMLDefinition as _learningmotors_pb_ie_IEMLDefinition
} from "./learningmotors/pb/ie/IEML";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      ie: {
        IEML: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_ie_IEMLClient> & {
          service: _learningmotors_pb_ie_IEMLDefinition;
        };
