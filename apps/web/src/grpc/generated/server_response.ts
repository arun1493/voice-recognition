...
export interface ProtoGrpcType {
  ...
  suki: {
    pb: {
      ...
      suki_internal: {
        suki_server: {
          MicNotificationResponse: MessageTypeDefinition;
          NotificationForReceiver: EnumTypeDefinition;
          NotificationForSender: EnumTypeDefinition;
          ServerResponse: MessageTypeDefinition;
          StateMutationResponse: EnumTypeDefinition;
        };
      };
      transfer_to_cursor: {
