...
import type {
  MsVoiceAgentClient as _suki_pb_voice_MsVoiceAgentClient,
  MsVoiceAgentDefinition as _suki_pb_voice_MsVoiceAgentDefinition
} from "./suki/pb/voice/MsVoiceAgent";
  ...
  suki: {
    pb: {
      ...
      voice: {
        ...
        MsVoiceAgent: SubtypeConstructor<typeof grpc.Client, _suki_pb_voice_MsVoiceAgentClient> & {
          service: _suki_pb_voice_MsVoiceAgentDefinition;
        };
        speechapis: {
