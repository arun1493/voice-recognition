...
import type {
  LighthouseClient as _learningmotors_pb_LighthouseClient,
  LighthouseDefinition as _learningmotors_pb_LighthouseDefinition
} from "./learningmotors/pb/Lighthouse";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      Lighthouse: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_LighthouseClient> & {
        service: _learningmotors_pb_LighthouseDefinition;
      };
      LighthouseEvent: MessageTypeDefinition;
      PageRequest: MessageTypeDefinition;
      PageResponse: MessageTypeDefinition;
      SessionDetailsRequest: MessageTypeDefinition;
      SessionDetailsResponse: MessageTypeDefinition;
      Statistics: MessageTypeDefinition;
      ...
      transcript: {
        Intents: MessageTypeDefinition;
        Transcript: MessageTypeDefinition;
        UISessionHeader: MessageTypeDefinition;
      };
      user: {
