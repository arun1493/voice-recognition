...
import type {
  StrmatchClient as _learningmotors_pb_ie_StrmatchClient,
  StrmatchDefinition as _learningmotors_pb_ie_StrmatchDefinition
} from "./learningmotors/pb/ie/Strmatch";
import type {
  ...
  learningmotors: {
    pb: {
      ...
      ie: {
        ...
        Strmatch: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_ie_StrmatchClient> & {
          service: _learningmotors_pb_ie_StrmatchDefinition;
        };
      };
      macros: {
