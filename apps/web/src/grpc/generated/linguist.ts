...
import type {
  LinguistClient as _learningmotors_pb_ie_LinguistClient,
  LinguistDefinition as _learningmotors_pb_ie_LinguistDefinition
} from "./learningmotors/pb/ie/Linguist";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      ie: {
        Linguist: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_ie_LinguistClient> & {
          service: _learningmotors_pb_ie_LinguistDefinition;
        };
