...
import type {
  GraffitiServiceClient as _learningmotors_pb_graffiti_GraffitiServiceClient,
  GraffitiServiceDefinition as _learningmotors_pb_graffiti_GraffitiServiceDefinition
} from "./learningmotors/pb/graffiti/GraffitiService";
import type {
  ...
  learningmotors: {
    pb: {
      ...
      graffiti: {
        CreateRequest: MessageTypeDefinition;
        CreateResponse: MessageTypeDefinition;
        GraffitiService: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_graffiti_GraffitiServiceClient> & {
          service: _learningmotors_pb_graffiti_GraffitiServiceDefinition;
        };
        InsertRequest: MessageTypeDefinition;
        InsertResponse: MessageTypeDefinition;
        IntentEvent: MessageTypeDefinition;
        UpdatePatientRequest: MessageTypeDefinition;
        UpdatePatientResponse: MessageTypeDefinition;
        UpdateRequest: MessageTypeDefinition;
        UpdateResponse: MessageTypeDefinition;
      };
      idl: {
