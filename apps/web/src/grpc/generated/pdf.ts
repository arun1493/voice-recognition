...
import type {
  PDFServiceClient as _learningmotors_pb_pdf_PDFServiceClient,
  PDFServiceDefinition as _learningmotors_pb_pdf_PDFServiceDefinition
} from "./learningmotors/pb/pdf/PDFService";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      pdf: {
        BulkPrintRequest: MessageTypeDefinition;
        BulkPrintResponse: MessageTypeDefinition;
        BulkSaveRequest: MessageTypeDefinition;
        BulkSaveResponse: MessageTypeDefinition;
        ConditionRequest: MessageTypeDefinition;
        ConditionResponse: MessageTypeDefinition;
        DocumentReferenceRequest: MessageTypeDefinition;
        DocumentReferenceResponse: MessageTypeDefinition;
        NoteRequest: MessageTypeDefinition;
        NoteResponse: MessageTypeDefinition;
        PDF: MessageTypeDefinition;
        PDFService: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_pdf_PDFServiceClient> & {
          service: _learningmotors_pb_pdf_PDFServiceDefinition;
        };
        ZIP: MessageTypeDefinition;
      };
      scope: {
