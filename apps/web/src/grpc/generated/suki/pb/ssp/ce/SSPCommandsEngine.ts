...
export interface SSPCommandsEngineClient extends grpc.Client {
  Intent(
...
export interface SSPCommandsEngineHandlers extends grpc.UntypedServiceImplementation {
...
export interface SSPCommandsEngineDefinition extends grpc.ServiceDefinition {
