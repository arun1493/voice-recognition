...
import type {
  SpeechProxyServiceClient as _learningmotors_pb_SpeechProxyServiceClient,
  SpeechProxyServiceDefinition as _learningmotors_pb_SpeechProxyServiceDefinition
} from "./learningmotors/pb/SpeechProxyService";
import type {
...
export interface ProtoGrpcType {
  ...
  learningmotors: {
    pb: {
      ...
      SilenceDetection: MessageTypeDefinition;
      SpeechProxyService: SubtypeConstructor<typeof grpc.Client, _learningmotors_pb_SpeechProxyServiceClient> & {
        service: _learningmotors_pb_SpeechProxyServiceDefinition;
      };
      StreamingRecognitionConfig: MessageTypeDefinition;
      StreamingRecognizeRequest: MessageTypeDefinition;
      StreamingRecognizeResponse: MessageTypeDefinition;
      SubsectionInfo: MessageTypeDefinition;
      TextResponse: MessageTypeDefinition;
      asr: {
